...
IF ~~ THEN BEGIN N49
  SAY @2
  IF ~~ THEN REPLY @3 GOTO N50
  IF ~~ THEN REPLY @4 EXTERN ~YOSHJ~ TS212
  IF ~~ THEN REPLY @5 GOTO N50
END
...
= @18
= @19
  IF ~~ THEN REPLY @20 GOTO N69
  IF ~~ THEN REPLY @21 GOTO N70
  IF ~~ THEN REPLY @22 GOTO N71
END
...
IF ~~ THEN BEGIN TS209
  SAY @111
  IF ~Global("YoshimoAndHisBetrayal","GLOBAL",0)~ THEN EXTERN ~PPIRENI1~ N47
  IF ~Global("YoshimoAndHisBetrayal","GLOBAL",1)~ THEN EXTERN ~PPIRENI2~ N18
END

IF ~~ THEN BEGIN TS210
  SAY @112
  IF ~Global("YoshimoAndHisBetrayal","GLOBAL",0)~ THEN EXTERN ~PPIRENI1~ N48
  IF ~Global("YoshimoAndHisBetrayal","GLOBAL",1)~ THEN EXTERN ~PPIRENI2~ N68
END

IF ~~ THEN BEGIN TS211
  SAY @113
  IF ~Global("YoshimoAndHisBetrayal","GLOBAL",0)~ THEN EXTERN ~PPIRENI1~ N49
  IF ~Global("YoshimoAndHisBetrayal","GLOBAL",1)~ THEN EXTERN ~PPIRENI2~ N69
END

IF ~~ THEN BEGIN TS212
  SAY @114
  IF ~Global("YoshimoAndHisBetrayal","GLOBAL",0)~ THEN EXTERN ~PPIRENI1~ N51
  IF ~Global("YoshimoAndHisBetrayal","GLOBAL",1)~ THEN EXTERN ~PPIRENI2~ N72
END

IF ~~ THEN BEGIN TS213
  SAY @115
  IF ~Global("YoshimoAndHisBetrayal","GLOBAL",0)~ THEN EXTERN ~PPIRENI1~ N52
